...
## 🚀 Featured Projects
- 🧠 **Blank**  
  AI-assisted creation environment  
  → https://blank.gibbons.fr
  
- ♟️ **Chess**  
  Multiplayer chess platform with AI, puzzles and local play  
...
- 🏫 **SchoolMS**  
  ...
  → https://schoolms.gibbons.fr

---

## 🧪 Other Projects

- 🖥️ Linuxgibs, a Linux terminal simulator : [get started !](https://linux.gibbons.fr) or [check the repository](https://github.com/flaviengibs/linuxgibs)  
- 🧬 NanoCore (browser game) : [try it here!](https://nanocore.gibbons.fr) or [check the repository](https://github.com/flaviengibs/nanocore)
...
Most projects are live and actively evolving.  
This profile focuses on building real, usable systems rather than isolated code samples.
